...
class MentionedAlbumListCrudController extends AbstractCrudController
{
    ...
    public function createIndexQueryBuilder(SearchDto $searchDto, EntityDto $entityDto, FieldCollection $fields, FilterCollection $filters): QueryBuilder
    {
        ...
        $qb->andWhere('entity.type = :type')
           ->setParameter('type', AlbumList::TYPE_MENTIONED);
    ...
    {
        return $crud
            ->setPageTitle('index', 'Mentioned Lists')
            ->setPageTitle('new', 'Create Mentioned List')
            ->setPageTitle('edit', 'Edit Mentioned List');
    }
    ...
    public function createEntity(string $entityFqcn)
    {
        ...
        $entity->setType(AlbumList::TYPE_MENTIONED);
        return $entity;
    }
}
